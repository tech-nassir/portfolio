  ...
  return (
    <div className='flex w-full font-poppins '>
      ...
      <div className="flex py-auto w-full sm:w-2/3 items-center justify-center min-h-screen bg-blue-50">
        ...
        <div className="py-2 px-8 space-y-14 bg-white rounded-lg justify-center shadow-xl w-4/5 h-3/4 my-auto sm:w-1/2 m-auto sm:h-4/5">
          <h2 className="text-xl  font-poppins mt-4 text-center text-slate-800">Login</h2>
          <form onSubmit={handleSubmit} className="space-y-10 my-auto ">
            <div>
              ...
              <input
                ...
                required
                className="w-full mt-1 h-10 sm:h-8  text-md sm:text-xs border border-gray-300 rounded-lg
   focus:outline-none focus:ring-2 focus:ring-blue-400"
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-1 mt-1 text-lg sm:text-xs h-10 sm:h-8 border border-gray-300 rounded-lg
   focus:outline-none focus:ring-2 focus:ring-blue-400"
              />
            </div>
            <button
              type="submit"
              className="w-full px-8 py-2 text-white bg-slate-700 text-md sm:text-xs h-10 sm:h-8 rounded-md hover:bg-slate-800
   focus:outline-none focus:ring-2 focus:ring-slate-200 hover:font-bold focus:ring-opacity-50 font-semibold"
            >
              Sign In
            </button>
          </form>
          <p className=" sm:text-xs text-center text-gray-600">
