    ...
    return (
        <div className="w-full  py-12 bg-slate-50  ">
          <div className="flex sm:mx-36 pb-12 flex-col sm:flex-row items-center">
            <div className="space-y-3">
                ...
                <p className="font-poppins sm:text-md sm:text-left text-center text-blue-800">Organisations Get the Right Personnel. Professionals Get Hired</p>
     ...
     <div className="flex sm:flex-row flex-col space-y-4 sm:ml-24 justify-evenly items-center">
        ...
        <div className="flex items-center">
            <YouTube className="text-red-600"/><p className="font-poppins text-md mx-2">/jobs-junction</p>
        </div>
        <div className="flex items-center">
            <Facebook className="text-blue-600"/><p className="font-poppins text-md mx-2">/jobs-junction</p>
        </div>
        <div className="flex items-center">
            <X className=""/><p className="font-poppins text-md mx-2">@jobs-junctiontz</p>
        </div>
     </div>
